...
**灵镜 (LingPrism)** 是一个面向企业的**项目知识与代码智能平台**，帮助企业员工高效理解项目架构、检索代码与知识资产，同时为技术管理者提供全局架构视图与风险感知能力。

### 面向用户

| 角色 | 典型用户 | 核心诉求 |
|------|----------|----------|
| **普通员工 / 开发者** | 一线研发、测试、产品、运维 | 自然语言提问获取项目知识，浏览架构图，语义/符号检索代码 |
| **技术负责人 / 管理员** | Tech Lead、平台管理员、知识库维护人 | 接入管理代码源，维护知识库与架构图，配置问答模板与预警规则 |
| **技术 Leader / 架构师** | 技术总监、企业架构师、SRE | 全局俯瞰项目健康度、架构合规性、知识库质量及平台运行状态 |
| **公司领导层** | CTO、研发 VP | 掌握整体研发资产健康状况、风险项目与知识沉淀情况 |

### 核心作用

- **知识民主化** — 将分散在代码仓库、设计文档、架构师脑中的隐性知识转化为可检索、可问答的统一知识体系，降低新人上手成本与信息不对称
- **代码智能** — 基于 Rust tree-sitter 解析构建代码知识图谱，结合向量语义检索与大模型问答，让员工以自然语言理解代码逻辑与依赖关系
- **架构治理** — 自动生成架构图并对比实际代码结构，检测架构漂移，保障架构演进可控、合规
- **风险感知** — 从代码健康度、架构合规、知识库质量、MCP 服务调用等多维度提供监控看板，帮助管理者及时发现并处置风险
- **对外服务** — 通过 MCP 协议标准化暴露平台能力，供 Cursor、Claude Code 等外部 AI Agent 调用

### 产品形态

平台由三大前端应用 + 多语言微服务后端组成：

| 应用 | 说明 |
|------|------|
| **用户平台** | 面向全体员工，提供智能问答、架构图浏览、代码检索等知识获取能力 |
| **管理后台** | 面向管理员，提供代码源接入、知识库维护、架构图治理、模板与预警配置等管理能力 |
| **监控平台** | 面向技术 Leader 与领导层，提供健康度、架构合规、知识库质量、MCP 调用等全局监控看板 |
