...
import {
  ...
  TestConnectionByUrlUseCase,
  UpdateRepoMetadataUseCase,
  UpdateRepoUseCase,
  DeleteRepoUseCase,
  SyncAndIndexRepoUseCase,
...
export function buildGraphQLContext(
  ...
  return {
    ...
    testConnectionByUrlUseCase: new TestConnectionByUrlUseCase(core),
    ...
    syncAndIndexRepoUseCase: new SyncAndIndexRepoUseCase(core),
